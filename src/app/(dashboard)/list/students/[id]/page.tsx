    ...
    <div className="p-4 flex gap-4 flex-col xl:flex-row flex-1">
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
          <Link className="p-3 rounded-md bg-lamaSkyLight" href="/">Kelas Murid</Link>
          <Link className="p-3 rounded-md bg-lamaPurpleLight" href="/">Guru murid</Link>
          <Link className="p-3 rounded-md bg-pink-50" href="/">Ujian</Link>
          <Link className="p-3 rounded-md bg-lamaSkyLight" href="/">Tugas</Link>
          <Link className="p-3 rounded-md bg-lamaYellowLight" href="/">Hasil</Link>
        </div>
      </div>
